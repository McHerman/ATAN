...
20:                                               ; preds = %20, %19
  %21 = load volatile i32, ptr inttoptr (i32 -2147418105 to ptr), align 4
  %22 = icmp uge i32 %21, 256
  br i1 %22, label %23, label %20

23:                                               ; preds = %20
  %24 = atomicrmw add ptr inttoptr (i32 -2147418105 to ptr), i32 -256 acquire, align 4
  br label %25
...
53:                                               ; preds = %25
  %54 = atomicrmw add ptr inttoptr (i32 -2147418109 to ptr), i32 256 release, align 4
  ret void
}

; Function Attrs: null_pointer_is_valid
define void @__impl_riscv_kernel_16(i32 %0, ptr %1, ptr %2, i32 %3, i32 %4, i32 %5, i32 %6, i32 %7, ptr %8, ptr %9, i32 %10, i32 %11, i32 %12, i32 %13, i32 %14) #0 {
  br label %16
...
; Function Attrs: null_pointer_is_valid
define void @__impl_riscv_kernel_15(ptr %0, ptr %1, i32 %2, i32 %3, i32 %4, ptr %5, ptr %6, i32 %7, i32 %8, i32 %9, i32 %10, i32 %11, ptr %12, ptr %13, i32 %14, i32 %15, i32 %16, i32 %17, i32 %18) #0 {
  br label %20

20:                                               ; preds = %20, %19
  %21 = load volatile i32, ptr inttoptr (i32 -2147418022 to ptr), align 4
  %22 = icmp uge i32 %21, 64
  br i1 %22, label %23, label %20

23:                                               ; preds = %20
  %24 = atomicrmw add ptr inttoptr (i32 -2147418022 to ptr), i32 -64 acquire, align 4
  br label %25
...
46:                                               ; preds = %25
  %47 = atomicrmw add ptr inttoptr (i32 -2147418018 to ptr), i32 64 release, align 4
  ret void
}
...
22:                                               ; preds = %22, %21
  %23 = load volatile i32, ptr inttoptr (i32 -2147417750 to ptr), align 4
  %24 = icmp uge i32 %23, 1024
  br i1 %24, label %25, label %22

25:                                               ; preds = %22
  %26 = atomicrmw add ptr inttoptr (i32 -2147417750 to ptr), i32 -1024 acquire, align 4
  br label %27
...
50:                                               ; preds = %27
  %51 = atomicrmw add ptr inttoptr (i32 -2147417746 to ptr), i32 1024 release, align 4
  ret void
}
...
22:                                               ; preds = %22, %21
  %23 = load volatile i32, ptr inttoptr (i32 -2147417798 to ptr), align 4
  %24 = icmp uge i32 %23, 1024
  br i1 %24, label %25, label %22

25:                                               ; preds = %22
  %26 = atomicrmw add ptr inttoptr (i32 -2147417798 to ptr), i32 -1024 acquire, align 4
  br label %27
...
50:                                               ; preds = %27
  %51 = atomicrmw add ptr inttoptr (i32 -2147417794 to ptr), i32 1024 release, align 4
  ret void
}
...
22:                                               ; preds = %22, %21
  %23 = load volatile i32, ptr inttoptr (i32 -2147417846 to ptr), align 4
  %24 = icmp uge i32 %23, 1024
  br i1 %24, label %25, label %22

25:                                               ; preds = %22
  %26 = atomicrmw add ptr inttoptr (i32 -2147417846 to ptr), i32 -1024 acquire, align 4
  br label %27
...
50:                                               ; preds = %27
  %51 = atomicrmw add ptr inttoptr (i32 -2147417842 to ptr), i32 1024 release, align 4
  ret void
}
...
22:                                               ; preds = %22, %21
  %23 = load volatile i32, ptr inttoptr (i32 -2147417639 to ptr), align 4
  %24 = icmp uge i32 %23, 1024
  br i1 %24, label %25, label %22

25:                                               ; preds = %22
  %26 = atomicrmw add ptr inttoptr (i32 -2147417639 to ptr), i32 -1024 acquire, align 4
  br label %27
...
50:                                               ; preds = %27
  %51 = atomicrmw add ptr inttoptr (i32 -2147417635 to ptr), i32 1024 release, align 4
  ret void
}
...
22:                                               ; preds = %22, %21
  %23 = load volatile i32, ptr inttoptr (i32 -2147417687 to ptr), align 4
  %24 = icmp uge i32 %23, 1024
  br i1 %24, label %25, label %22

25:                                               ; preds = %22
  %26 = atomicrmw add ptr inttoptr (i32 -2147417687 to ptr), i32 -1024 acquire, align 4
  br label %27
...
50:                                               ; preds = %27
  %51 = atomicrmw add ptr inttoptr (i32 -2147417683 to ptr), i32 1024 release, align 4
  ret void
}
...
22:                                               ; preds = %22, %21
  %23 = load volatile i32, ptr inttoptr (i32 -2147417735 to ptr), align 4
  %24 = icmp uge i32 %23, 1024
  br i1 %24, label %25, label %22

25:                                               ; preds = %22
  %26 = atomicrmw add ptr inttoptr (i32 -2147417735 to ptr), i32 -1024 acquire, align 4
  br label %27
...
50:                                               ; preds = %27
  %51 = atomicrmw add ptr inttoptr (i32 -2147417731 to ptr), i32 1024 release, align 4
  ret void
}
...
22:                                               ; preds = %22, %21
  %23 = load volatile i32, ptr inttoptr (i32 -2147417783 to ptr), align 4
  %24 = icmp uge i32 %23, 1024
  br i1 %24, label %25, label %22

25:                                               ; preds = %22
  %26 = atomicrmw add ptr inttoptr (i32 -2147417783 to ptr), i32 -1024 acquire, align 4
  br label %27
...
50:                                               ; preds = %27
  %51 = atomicrmw add ptr inttoptr (i32 -2147417779 to ptr), i32 1024 release, align 4
  ret void
}
...
50:                                               ; preds = %27
  %51 = atomicrmw add ptr inttoptr (i32 -2147417620 to ptr), i32 1024 release, align 4
  ret void
}
...
22:                                               ; preds = %22, %21
  %23 = load volatile i32, ptr inttoptr (i32 -2147417672 to ptr), align 4
  %24 = icmp uge i32 %23, 1024
  br i1 %24, label %25, label %22

25:                                               ; preds = %22
  %26 = atomicrmw add ptr inttoptr (i32 -2147417672 to ptr), i32 -1024 acquire, align 4
  br label %27
...
50:                                               ; preds = %27
  %51 = atomicrmw add ptr inttoptr (i32 -2147417668 to ptr), i32 1024 release, align 4
  ret void
}
...
22:                                               ; preds = %22, %21
  %23 = load volatile i32, ptr inttoptr (i32 -2147417720 to ptr), align 4
  %24 = icmp uge i32 %23, 1024
  br i1 %24, label %25, label %22

25:                                               ; preds = %22
  %26 = atomicrmw add ptr inttoptr (i32 -2147417720 to ptr), i32 -1024 acquire, align 4
  br label %27
...
50:                                               ; preds = %27
  %51 = atomicrmw add ptr inttoptr (i32 -2147417716 to ptr), i32 1024 release, align 4
  ret void
}
...
22:                                               ; preds = %22, %21
  %23 = load volatile i32, ptr inttoptr (i32 -2147417816 to ptr), align 4
  %24 = icmp uge i32 %23, 1024
  br i1 %24, label %25, label %22

25:                                               ; preds = %22
  %26 = atomicrmw add ptr inttoptr (i32 -2147417816 to ptr), i32 -1024 acquire, align 4
  br label %27

27:                                               ; preds = %27, %25
  %28 = load volatile i32, ptr inttoptr (i32 -2147417768 to ptr), align 4
  %29 = icmp uge i32 %28, 1024
  br i1 %29, label %30, label %27

30:                                               ; preds = %27
  %31 = atomicrmw add ptr inttoptr (i32 -2147417768 to ptr), i32 -1024 acquire, align 4
  br label %32
...
55:                                               ; preds = %32
  %56 = atomicrmw add ptr inttoptr (i32 -2147417812 to ptr), i32 1024 release, align 4
  %57 = atomicrmw add ptr inttoptr (i32 -2147417764 to ptr), i32 1024 release, align 4
  ret void
}

; Function Attrs: null_pointer_is_valid
define void @riscv_kernel_0() #0 {
  call void @__impl_riscv_kernel_0(ptr inttoptr (i32 -2147479552 to ptr), ptr inttoptr (i32 -2147479552 to ptr), i32 0, i32 16, i32 16, i32 16, i32 1, ptr inttoptr (i32 -2147478272 to ptr), ptr inttoptr (i32 -2147478272 to ptr), i32 0, i32 16, i32 16, i32 16, i32 1, ptr inttoptr (i32 -2147459072 to ptr), ptr inttoptr (i32 -2147459072 to ptr), i32 0, i32 16, i32 16, i32 16, i32 1)
  ret void
}
...
define void @riscv_kernel_14() #0 {
  call void @__impl_riscv_kernel_14(ptr inttoptr (i32 -2147460352 to ptr), ptr inttoptr (i32 -2147460352 to ptr), i32 0, i32 16, i32 16, i32 16, i32 1, ptr inttoptr (i32 -2147445760 to ptr), ptr inttoptr (i32 -2147445760 to ptr), i32 0, i32 16, i32 16, i32 16, i32 1, ptr inttoptr (i32 -2147444736 to ptr), ptr inttoptr (i32 -2147444736 to ptr), i32 0, i32 16, i32 16, i32 16, i32 1)
  ret void
}
...
define void @riscv_kernel_16() #0 {
  call void @__impl_riscv_kernel_16(i32 0, ptr inttoptr (i32 -2147443712 to ptr), ptr inttoptr (i32 -2147443712 to ptr), i32 0, i32 16, i32 16, i32 16, i32 1, ptr inttoptr (i32 -2147442624 to ptr), ptr inttoptr (i32 -2147442624 to ptr), i32 0, i32 16, i32 16, i32 16, i32 1)
  ret void
}

; Function Attrs: null_pointer_is_valid
define void @riscv_kernel_17() #0 {
  call void @__impl_riscv_kernel_17(ptr inttoptr (i32 -2147441600 to ptr), ptr inttoptr (i32 -2147441600 to ptr), i32 0, i32 16, i32 16, i32 16, i32 1, i64 1091133696, i64 17179869184, i64 35, i64 -128, i64 127, ptr inttoptr (i32 -2147442624 to ptr), ptr inttoptr (i32 -2147442624 to ptr), i32 0, i32 16, i32 16, i32 16, i32 1)
  ret void
}
