...
class MemSystemThreeTierTest extends AnyFreeSpec with Matchers with ChiselSim {
  ...
  def idlePorts(dut: ThreeTierDUT): Unit = {
    ...
    for (i <- 0 until 2) {
      ...
      for (j <- 0 until 2) {
        ...
        dut.io.dma(i).descriptor.bits(j).semaphore.semEnable.poke(false.B)
        dut.io.dma(i).descriptor.bits(j).semaphore.semAddr.poke(0.U)
        dut.io.dma(i).descriptor.bits(j).semaphore.semStepSize.poke(0.U)
        dut.io.dma(i).descriptor.bits(j).semaphore.mode.poke(0.U)
      }
    }
  ...
  def runDMA(
    ...
    ifc.descriptor.bits(0).semaphore.semEnable.poke(semEn0.B)
    ifc.descriptor.bits(0).semaphore.semAddr.poke(semAddr0.U)
    ifc.descriptor.bits(0).semaphore.semStepSize.poke(semStep0.U)
    ifc.descriptor.bits(0).semaphore.mode.poke(SemaphoreAccessModes.RestartOnStep)
    ...
    ifc.descriptor.bits(1).semaphore.semEnable.poke(semEn1.B)
    ifc.descriptor.bits(1).semaphore.semAddr.poke(semAddr1.U)
    ifc.descriptor.bits(1).semaphore.semStepSize.poke(semStep1.U)
    ifc.descriptor.bits(1).semaphore.mode.poke(SemaphoreAccessModes.RestartOnStep)
  ...
  "Three-tier MemSystem: DMA chain with semaphore-synchronized transfers" in {
    simulate(new ThreeTierDUT(msCfg, bankCfg)) { dut =>
      ...
      dut.io.dma(0).descriptor.bits(0).semaphore.semEnable.poke(false.B)
      ...
      dut.io.dma(0).descriptor.bits(1).semaphore.semEnable.poke(false.B)
      ...
      dut.io.dma(1).descriptor.bits(0).semaphore.semEnable.poke(true.B)
      dut.io.dma(1).descriptor.bits(0).semaphore.semAddr.poke(SEM_DMA1_A.U)
      dut.io.dma(1).descriptor.bits(0).semaphore.semStepSize.poke(N.U)
      dut.io.dma(1).descriptor.bits(0).semaphore.mode.poke(SemaphoreAccessModes.RestartOnStep)
      ...
      dut.io.dma(1).descriptor.bits(1).semaphore.semEnable.poke(false.B)
      ...
      dut.io.dma(1).descriptor.bits(0).source.poke(0.U)
      dut.io.dma(1).descriptor.bits(0).sink.poke(0.U)
      dut.io.dma(1).descriptor.bits(0).semaphore.semEnable.poke(false.B)
      dut.io.dma(1).descriptor.bits(1).addr.poke(0.U)
      dut.io.dma(1).descriptor.bits(1).size.poke(N.U)
      ...
      dut.io.dma(0).descriptor.bits(1).source.poke(0.U)
      dut.io.dma(0).descriptor.bits(1).sink.poke(0.U)
      dut.io.dma(0).descriptor.bits(1).semaphore.semEnable.poke(true.B)
      dut.io.dma(0).descriptor.bits(1).semaphore.semAddr.poke(SEM_DMA0_B.U)
      dut.io.dma(0).descriptor.bits(1).semaphore.semStepSize.poke(N.U)
      dut.io.dma(0).descriptor.bits(1).semaphore.mode.poke(SemaphoreAccessModes.RestartOnStep)
