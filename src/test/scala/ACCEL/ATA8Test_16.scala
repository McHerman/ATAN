...
class ATA8Test_16 extends AnyFreeSpec with Matchers with ChiselSim {
  ...
  "ATA8_16 should execute unalligned" in {
    //val n = 2 + Random.nextInt(30)
    val n = 18
  ...
  "ATA8_16 should execute twice" in {
    //val n = 2 + Random.nextInt(30)
    val n = 32
